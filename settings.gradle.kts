...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            plugin("kotlin", "org.jetbrains.kotlin.jvm").versionRef("kotlin-version")
            plugin("spring-dependency", "io.spring.dependency-management").versionRef("spring-dependency-version")
            plugin("spring-boot", "org.springframework.boot").versionRef("spring-boot-version")
            plugin("shadow", "com.github.johnrengelman.shadow").versionRef("shadow-plugin-version")
